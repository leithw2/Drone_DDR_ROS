...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(125-50, -100, 1280, 720))
        ...
        self.pushButton_takeoff = QtWidgets.QPushButton(Dialog)
        self.pushButton_takeoff.setGeometry(QtCore.QRect(l_x+325, l_y, button_size_w+50, button_size_h))
        self.pushButton_takeoff.setObjectName("pushButton")
        self.pushButton_takeoff.setText("Takeoff")

        self.pushButton_land = QtWidgets.QPushButton(Dialog)
        self.pushButton_land.setGeometry(QtCore.QRect(l_x+325, l_y+100, button_size_w+50, button_size_h))
        self.pushButton_land.setObjectName("pushButton")
        self.pushButton_land.setText("Land")


        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)

        self.cmc_vel_pub = rospy.Publisher("/bebop2/cmd_vel",Twist)
        self.vel_msg = Twist()
        self.bridge = CvBridge()
        self.empty_msg = Empty()
        self.image_sub = rospy.Subscriber("/bebop2/image_raw",Image,self.callback)
        self.land_pub = rospy.Publisher("bebop2/land", Empty, queue_size=10)
        self.takeoff_pub = rospy.Publisher("bebop2/takeoff", Empty, queue_size=10 )
        self.battery_sub = rospy.Subscriber("/bebop2/states/common/CommonState/BatteryStateChanged",CommonCommonStateBatteryStateChanged,self.callback2)
        ...
        self.pushButton_takeoff.clicked.connect(self.to_takeoff)
        self.pushButton_land.clicked.connect(self.to_land)
